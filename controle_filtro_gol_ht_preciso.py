"""Circuit breaker isolado da entrega do filtro HT antecipado preciso."""
...
VERSAO_CONTROLE = "controle-filtro-gol-ht-antecipado-preciso-v1"
ARQUIVO_ESTADO = Path(__file__).with_name(
    "filtro_gol_ht_antecipado_preciso_estado.json"
)
...
def suspender(
    ...
    documento = {
        ...
        "reativacao": "python controlar_filtro_gol_ht_preciso.py --ativar",
    }
    return {
...
def ativar(caminho=None, agora=None, motivo="reativacao_manual"):
    ...
    documento = {
        ...
        "atualizado_em": instante,
        "metricas": {},
        "rollback": "python controlar_filtro_gol_ht_preciso.py --suspender",
    }
    return {
        **_gravar(caminho, documento),
        "alterado": True,
